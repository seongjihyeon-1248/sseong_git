...
const Services = () => {
  const servicesList = [
    {
      id: 1,
      title: '고급 화질 개발',
      description: '고객의 요구사항에 맞는 최적화된 화질을 제공합니다.',
      icon: '💻'
    },
    {
      id: 2,
  ...
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={index} className="relative p-6 bg-white rounded-xl shadow-md">
              <div className="text-green-800 text-5xl font-bold mb-4">{item.step}</div>
      ...
      <div className="mt-32 bg-green-800 rounded-2xl p-12 text-center text-white">
        ...
        <button className="bg-white text-green-800 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
          무료 상담 신청하기
        </button>
      </div>
    </div>
