fun main(){
    ...
    var array = arrayOf(0, 1, 2)            //배열          //출력하면 깨짐 & 가변
    var arraylist = arrayListOf(0, 1, 2)    //배열 리스트   //출력해도 안깨짐 & 가변
    var list = listOf(0, 1, 2)              //리스트        //출력해도 안깨짐 & 불가변

    b = if((b + 2) % 3 == 0) 0 else 1
    ...
    when(b){ 
        0               -> print("i'm 0: " + b)      
        1,2             -> print("i'm 1 or 2: " + b)  
        in 3..4         -> print("i'm 3 ~ 4: " + b)  
        !in 2..6        -> print("i'm not 2, 3: " + b)   
        else            -> print("i'm just not...: " + b)
    }
   /*
        !코틀린 기본 문법!
        .자바를 안다는 가정으로 필기.
